 ...
 *************************************************************************
 ...
 Prop�sito:                  Clase en las cuales se definen las operaciones CRUD frente a las tablas que tienen relaci�n con la aplicaci�n Sistema y todos sus m�dulos
*/
...
class SystemModel extends CI_Model {
	...
	public function insertEncList($nombre, $usuario){
		/** Se inserta la informaci�n de la tabla ADM_ENCLISTA*/
    ...
    public function insertDetList($idEncList,$idioma,$valor,$nombre, $usuario){
        /** Se inserta la informaci�n de la tabla ADM_DETLISTA*/
    ...
    public function insertEncMessage($nombre, $tipo,$usuario){
    	/** Se inserta la informaci�n de la tabla ADM_ENCMENSAJE*/
    ...
    public function insertDetMessage($id,$titulo, $mensaje,$idioma,$usuario){
    	/** Se inserta la informaci�n de la tabla ADM_DETMENSAJE*/
    ...
    public function insertProfile($nombre, $usuario){
        /** Se inserta la informaci�n de la tabla ADM_PERFIL*/
    ...
    public function insertProfileRol($perfil,$rol, $usuario){
        /** Se inserta la informaci�n de la tabla ADM_ROLPERFIL*/
    ...
    public function insertModule($idModule,$tipoModulo,$tipo,$pagina,$clase, $usuario){
        /** Se inserta la informaci�n de la tabla ADM_MODULO*/
    ...
    public function insertModuleName($idModule,$nombre,$idioma,$usuario){
        /** Se inserta la informaci�n de la tabla ADM_MODNOMBRE*/
        $data = array(
                'ID_MODULO' => $idModule,
                'ID' => $idModule,
                'NOMBRE' => $nombre,
    ...
    public function insertModuleProfile($idModule,$profile,$usuario){
        /** Se inserta la informaci�n de la tabla ADM_MODROLPER*/
    ...
    public function insertEncFunction($modulo, $nombre,$tipo,$pagina,$funcion,$icono,$usuario){
    	/** Se inserta la informaci�n de la tabla ADM_MODFUNCIONES*/
    ...
    public function insertDetFunction($encabezado, $perfil,$usuario){
    	/** Se inserta la informaci�n de la tabla ADM_MODFUNROLPER*/
    ...
    public function updateEncList($id,$nombre, $usuario){
        /** Se actualiza la informaci�n de la tabla ADM_ENCLISTA*/
        $data = array(
                'NOMBRE' => $nombre,
                'ESTADO' => 'S',
                'UMOD' => $usuario,
    ...
    public function updateProfile($id,$nombre, $usuario){
        /** Se actualiza la informaci�n de la tabla ADM_PERFIL*/
        $data = array(
                'NOMBRE' => $nombre,
                'UMOD' => $usuario,
                'FMOD' => cambiaHoraServer()
    ...
    public function updateModulo($id,$pagina,$clase,$tipo,$tipoMod,$modulo, $usuario){
        /** Se actualiza la informaci�n de la tabla ADM_MODULO*/
        $data = array(
                'PAGINA' => $pagina,
                'CLASE' => $clase,
                'ID_TIPO' => $tipo,
    ...
    public function updateFunction($id,$nombre,$idModule,$tipo,$pagina,$clase,$ubicacion,$color, $usuario){
     ...
     public function deletePermissions($id){
        /** Elimina relaciones de los m�dulos para el modulo con id: $id*/
        $this->db->where('ID_MODULO', $id);
        $this->db->delete('ADM_MODROLPER');
    }
    
    public function deletePermissionsModuleRol($id,$rolPerfil){
    	 /** Elimina relaciones de los m�dulos para el modulo con id: $id y rolperfil:$rolPerfil */
    	$this->db->where('ID_MODULO', $id);
    	$this->db->where('ID_ROLPERFIL', $rolPerfil);
    	$this->db->delete('ADM_MODROLPER');
    }
    public function deletePermissionsFunction($id){
        /** Elimina relaciones de los m�dulos con los permisos de perfil de usuario*/
    ...
    public function getListMailFromProfile($id){
        /** Obtiene los correos electr�nicos de los usuarios que tienen el perfil $id*/
