 ...
 *************************************************************************
 ...
 Prop�sito:                  Funciones de las actividades generales que se tienen que realizar hacia la tabla usuarios
*/
...
class Users extends CI_Model {
	...
	public function insertUser($id,$nombres, $apellidos, $correo,$telefono ,$ruta ,$clave,$pagina ,$usuario){
	...
	public function insertUserReporte($usuario,$modulo,$usuario2,$estadoDefecto){
		 ...
		 *  usuario que realizar� el reporte*/
		$data = array(
				'USUARIO' => $usuario,
				'MODULO' => $modulo,
				'NOMBRES' => '1',
    ...
    public function insertUserHistory($idUsuario,$origen){
        /** Guardo el historico de ingreso de sesi�n*/
    ...
    public function updateUser($id,$nombres, $apellidos, $correo,$telefono,$ruta ,$pagina ,$usuario){
        /** Rutina para hacer el insert sobre la tabla usuarios, se reciben los valores de 
         *  nombres apellidos, clave, y usuario que realiza la operaci�n*/
    	if ($pagina==null){
    		$data = array(
