...
class ShelterConfigurationResidetType extends CI_Controller {
 ...
 public function __construct()
	...
	public function board(){
        ...
        $mainPage="ShelterConfigurationResidetType/board"; 
if ($this->FunctionsAdmin->validateSession ( $mainPage )) {
            ...
            //Lista de listas
            $data['listaLista']=$this->FunctionsGeneral->selectValoresListaTabla("HP_TIPOUSUARIO");
...
if ($this->FunctionsAdmin->validateSession ( $mainPage )) {
    		...
    		$data['title']="Crear definici&oacute;n de tipos de usuarios ";
    		$data['mainField']="Nombre";
    		$data['placeHolder']="Ej.  Paciente ";
    		$data['pagina']="ShelterConfigurationResidetType/saveRegister";
    		$data['mainPage']=$mainPage;
    		
    		//Cargo vista
    		$this->load->view('common/forms/formOneValue',$data);
    		// Cargo validación de formulario
    		$this->load->view('validation/shelter/configuration/shelterConfigurationResidetTypeValidation');
    ...
    public function edit($id){
    	...
    	$mainPage="ShelterConfigurationResidetType/board"; 
if ($this->FunctionsAdmin->validateSession ( $mainPage )) {
    		$id=$this->FunctionsGeneral->getFieldFromTable("HP_TIPOUSUARIO","ID",$this->encryption->decrypt($id));
    		if ($id!=''){
    			...
    			$data['nombre']=$this->FunctionsGeneral->getFieldFromTable("HP_TIPOUSUARIO","NOMBRE",$id);
    			//Inicializo variables de los campos del formulario
    			$data['title']="Modificar definici&oacute;n de tipos de usuarios ";
	    		$data['mainField']="Nombre";
	    		$data['placeHolder']="Ej.  Paciente";
    			$data['pagina']="ShelterConfigurationResidetType/saveRegister";
    			$data['mainPage']=$mainPage;
    			...
    			redirect(base_url()."ShelterConfigurationResidetType/board");
    		}
...
if ($this->FunctionsAdmin->validateSession ( $mainPage )) {
    		...
    		if ($this->encryption->decrypt($this->security->xss_clean($this->input->post('valida')))=='newRegister'){
    			if ($this->FunctionsGeneral->getQuantityFieldFromTable("HP_TIPOUSUARIO","NOMBRE",$nombre)==0){
    				//Creo el registro
    				$id=$this->FunctionsGeneral->insertOneParameter("HP_TIPOUSUARIO","NOMBRE",$nombre, $this->session->userdata('usuario'));
    			...
    			$this->FunctionsGeneral->updateByID("HP_TIPOUSUARIO","NOMBRE", 
...
if ($this->FunctionsAdmin->validateSession ( $mainPage )) {
    		...
    		$id=$this->FunctionsGeneral->getFieldFromTable("HP_TIPOUSUARIO","ID",$this->encryption->decrypt($id));
    		if ($id!=''){
    			$estado=$this->FunctionsGeneral->getFieldFromTable("HP_TIPOUSUARIO","ESTADO",$id);
    			if($estado=='S'){
    				$estado='N';
