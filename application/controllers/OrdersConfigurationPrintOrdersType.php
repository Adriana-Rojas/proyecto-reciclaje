 ...
 *************************************************************************
 ...
 Propósito:						Controlador para visualizar el manejo de los impresiones de los diferentes tipos de ordenes.
 *************************************************************************
 *************************************************************************
...
class OrdersConfigurationPrintOrdersType extends CI_Controller {
 ...
 public function __construct()
	...
	public function board(){
        ...
        $mainPage="OrdersConfigurationPrintOrdersType/board"; 
if ($this->FunctionsAdmin->validateSession ( $mainPage )) {
            ...
            //Lista de listas
            $data['listaLista']=$this->FunctionsGeneral->selectValoresListaTabla("ORD_IMPTIPO");
...
if ($this->FunctionsAdmin->validateSession ( $mainPage )) {
    		...
    		$data['title']="Crear tipo de impresi&oacute;n para tipo de orden ";
    		$data['mainField']="Tipo de  impresi&oacute;n";
    		$data['placeHolder']="Ej.  Impresi&oacute;n elementos ";
    		$data['pagina']="OrdersConfigurationPrintOrdersType/saveRegister";
    		$data['mainPage']=$mainPage;
    		
    		//Cargo vista
    		$this->load->view('common/forms/formOneValue',$data);
    		// Cargo validación de formulario
    		$this->load->view('validation/orders/configuration/ordersConfigurationPrintOrdersTypeValidation');
    ...
    public function edit($id){
    	...
    	$mainPage="OrdersConfigurationPrintOrdersType/board"; 
if ($this->FunctionsAdmin->validateSession ( $mainPage )) {
    		$id=$this->FunctionsGeneral->getFieldFromTable("ORD_IMPTIPO","ID",$this->encryption->decrypt($id));
    		if ($id!=''){
    			...
    			$data['nombre']=$this->FunctionsGeneral->getFieldFromTable("ORD_IMPTIPO","NOMBRE",$id);
    			//Inicializo variables de los campos del formulario
    			$data['title']="Modificar tipo de impresi&oacute;n para tipo de orden ";
	    		$data['mainField']="Tipo de  impresi&oacute;n";
	    		$data['placeHolder']="Ej.  Impresi&oacute;n elementos ";
    			$data['pagina']="OrdersConfigurationPrintOrdersType/saveRegister";
    			$data['mainPage']=$mainPage;
    			...
    			redirect(base_url()."OrdersConfigurationPrintOrdersType/board");
    		}
...
if ($this->FunctionsAdmin->validateSession ( $mainPage )) {
    		...
    		if ($this->encryption->decrypt($this->security->xss_clean($this->input->post('valida')))=='newRegister'){
    			if ($this->FunctionsGeneral->getQuantityFieldFromTable("ORD_IMPTIPO","NOMBRE",$nombre)==0){
    				//Creo el registro
    				$id=$this->FunctionsGeneral->insertOneParameter("ORD_IMPTIPO","NOMBRE",$nombre, $this->session->userdata('usuario'));
    			...
    			$this->FunctionsGeneral->updateByID("ORD_IMPTIPO","NOMBRE", 
...
if ($this->FunctionsAdmin->validateSession ( $mainPage )) {
    		...
    		$id=$this->FunctionsGeneral->getFieldFromTable("ORD_IMPTIPO","ID",$this->encryption->decrypt($id));
    		if ($id!=''){
    			$estado=$this->FunctionsGeneral->getFieldFromTable("ORD_IMPTIPO","ESTADO",$id);
    			if($estado=='S'){
    				$estado='N';
