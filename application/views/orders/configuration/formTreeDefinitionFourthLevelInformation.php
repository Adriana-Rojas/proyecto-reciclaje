	                        ...
	                        <div class="card">
	                           <div class="card-body">
	                            ...
	                            <div class="table-responsive">
                                    <table id="demo-foo-addrow" class="table"  style="width: 50%" data-page-size="200000">
                                        <thead>
                                            <tr align="center">
                                                <th align="center">Primer nivel</th>
                                                <th align="center">Primer sub nivel</th>
                                                <th align="center">Segundo sub nivel</th>
                                                <?php 
                                        ...
                                        <tbody>
                                            ...
                                            <tr align="center">
                                                <td><?= $value->NOMBRE;?></td>
                                                <td><?= $value->SUBNIVEL;?></td>
                                                <td><?= $value->SUBNIVEL2;?></td>
                                                <?php 
                                                	$i=0;
                                                	if($listaDatosNivVal != null){
                                                		foreach ($listaDatosNivVal as $v) {
