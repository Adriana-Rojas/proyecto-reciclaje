	                            ...
	                            <div class="form-group">
                                    ...
                                    <div class="col-md-12">
	                                    <input type="text" class="form-control" id="nombre" name="nombre" 
	                                    	value="<?= $nombre ?>"
	                                        placeholder="Ej. Ganchos">
	                                    <div class="form-control-feedback" > </div>
                                    </div>
                               </div>
                               <div class="form-group">
	                                        <label class="col-md-12" for="padre">Parte de cuerpo * </label>
	                                        <div class="col-md-12">
	                             ...
	                             <div class="form-group">
	                                        <label class="col-md-12" for="madre">Tipo de elemento* </label>
	                                        <div class="col-md-12">
	                                            <select class="form-control" id="madre" name="madre">
                                                            <option value="">--- Seleccione una opci&oacute;n ---</option>
                                                            <?php foreach ($listaMadre->result() as $value) { 
                                                                        if($value->ID==$tipoMadre){
                                                                            $selected="selected='selected'";
                                                                        }else{
                                                                            $selected="";
                                                                        }
	                             ...
	                             <div class="form-group">
	                                        <label class="col-md-12" for="unidad">Unidad de medida * </label>
	                                        <div class="col-md-12">
