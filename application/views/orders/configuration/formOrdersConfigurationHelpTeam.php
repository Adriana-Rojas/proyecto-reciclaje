                ...
                autocomplete="off">
	                <div class="row">
	                    <div class="col-12">
	                        <div class="card">
	                            <div class="card-body">
	                                <h4 class="card-title">Equipo de apoyo </h4>
	                                <h6 class="card-subtitle">Identifique los perfiles que apoyan el proceso de generaci&oacute;n de la orden</h6>
	                            </div>
	                            <div class="row">
                               		<!-- Column -->
                                        	...
                                        	<?php 
	                                        	if ($listaPerfil!=null){
	                                        		foreach ($listaPerfil->result() as $value) { 
	                                        			...
	                                        			$idGrupo=$this->FunctionsGeneral->getFieldFromTableNotId("ORD_DEFEQUIPOORDEN","ID","ID_TIPOORDEN",$id);
	                                        			if ($idGrupo!=''){
	                                        				$idGrupoDetalle=$this->FunctionsGeneral->getFieldFromTableNotIdFields(
	                                        						"ORD_DETDEFEQUIPOORDEN","ID","ID_INFROL",$rolPerfil,"ID_DEFEQUIPO",$idGrupo);
	                                        				
	                                        				if($idGrupoDetalle!=''){
	                                        					//Existe relación debo ahora verificar si está en obligatorio
	                                        					$obligatorio=$this->FunctionsGeneral->getFieldFromTable("ORD_DETDEFEQUIPOORDEN","OBLIGATORIO",$idGrupoDetalle);
