	                    ...
	                    <div class="col-12">
	                        <div class="card">
	                            ...
	                            <div class="form-group">
                                    ...
                                    <div class="col-md-12">
	                                    <select class="form-control" id="grupo" name="grupo">
                                            ...
                                            <?php 
                                            	foreach ($listaGrupos->result() as $value) { 
                                            		if ($this->FunctionsGeneral->getQuantityFieldFromTable("ORD_ELEMENTO","ID_GRUELEM",$value->ID)==0){      	
                                            ?>
                               ...
                               <div class="form-group">
                                    ...
                                    <div class="col-md-12">
	                                    <select class="form-control" id="caracteristica" name="caracteristica">
                                        	<option value="">--- Seleccione una opci&oacute;n ---</option>
	                                        </select>
	                                    <div class="form-control-feedback" > </div>
                                    </div>
                               ...
                               <div class="form-group aplica"  style="display: none;">
