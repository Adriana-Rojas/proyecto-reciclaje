            ...
            jQuery(function($) {
                ...
                $('#form_sample_3').validate({
                    ...
                    messages: {
                        ...
                        auxiliar:"Ingrese el c<?= LETRA_MIN_O?>digo del producto o servicio que desea configurar",
                    	precio:"Ingrese el precio del producto o servicio que desea configurar"
