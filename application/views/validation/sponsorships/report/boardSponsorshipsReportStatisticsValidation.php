        ...
        <script type="text/javascript">
            jQuery(function($) {
                ...
                $('#form_sample_3').validate({
                    ...
                    messages: {
                    	mes:"Seleccione el mes para ejecutar el reporte",
                    	ano:"Seleccione el a<?= LETRA_MIN_N?>o para ejecutar el reporte",
                    	tipo:"Seleccione el tipo de reporte que desea generar"
