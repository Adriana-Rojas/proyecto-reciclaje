        ...
        <script type="text/javascript">
            jQuery(function($) {
                ...
                $('#form_sample_3').validate({
                    ...
                    messages: {
                        nombre:"Digite el identificador del mensaje que desea crear o modificar",
                        tipo:"Seleccione el tipo de alerta asociado al mensaje",
                        titulo:"Digite el titulo del mensaje que desea crear o modificar",
                        mensaje:"Digite el mensaje desea crear o modificar"
                    },
