        ...
        <script type="text/javascript">
            jQuery(function($) {
                ...
                $('#form_sample_3').validate({
                    ...
                    messages: {
                        nombre:"Digite el nombre del participante que desea crear o modificar",
                        padre:"Seleccione el tipo de participante al cual corresponde el registro que est<?= LETRA_MIN_A; ?> creando o actualizando"
                    },
