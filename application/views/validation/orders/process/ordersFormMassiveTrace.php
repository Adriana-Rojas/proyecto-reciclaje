        ...
        <script type="text/javascript">
            jQuery(function($) {
                ...
                $('#form_sample_3').validate({
                    ...
                    messages: {
                    	tipo:"Seleccione la observaci<?= LETRA_MIN_O;?>n con la cual realizar<?= LETRA_MIN_A;?> el seguimiento en bloque",
                    	cantidad:{
                    		min:"Como m<?= LETRA_MIN_I;?>nimo debe seleccionar un orden para hacer el seguimiento"
                        },
                        observacion:"Digite la observaci<?= LETRA_MIN_O;?>n de seguimiento"
