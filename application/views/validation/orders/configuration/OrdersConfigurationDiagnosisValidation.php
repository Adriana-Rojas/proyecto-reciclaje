        ...
        <script type="text/javascript">
            jQuery(function($) {
                ...
                $('#form_sample_3').validate({
                    ...
                    messages: {
                        nombre:"Digite el diagn<?= LETRA_MIN_O;?>stico m<?= LETRA_MIN_E;?>dico que desea crear o modificar",
                        apoyo:"Digite el c<?= LETRA_MIN_O;?>digo diagn<?= LETRA_MIN_O;?>stico m<?= LETRA_MIN_E;?>dico que desea crear o modificar"
                    },
