...
?>
                ...
                action="<?= base_url()?>ShelterAppShelter/saveCheckIn" 
                id="form_sample_3" 
                method="post"       
					                autocomplete="off">
							...
							<div class="col-sm-12">
								<div class="card">
									<div class="card-body">
										...
										<h5 class="card-title"><i class="fa fa-sign-in fa-2x"></i> Ingreso al hogar de paso</h5>
										<div class="row">
										...
										<div class="form-group">
											...
											<div class="col-md-12">
												<input type="text" class="form-control" name="dingreso"
													id="dingreso" placeholder="<?= DATE_FORMAT_EVOLUTION;?>">
					
					
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-12" for="hingreso">Hora de ingreso * </label>
											<div class="col-md-12">
												<input type="text" class="form-control clockpicker"
													name="hingreso" id="hingreso">
											</div>
										</div>
									</div>
								</div>
