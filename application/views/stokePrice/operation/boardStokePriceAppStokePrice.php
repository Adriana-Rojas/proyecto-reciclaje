					...
					<table id="myTable" class="display nowrap table table-hover table-striped table-bordered">
						<thead>
							<tr>
								...
								<th>Whatsapp de Cliente</th>
								<th>Whatsapp Reciclador</th>
								<!-- <th >Valor</th> -->
							...
							?>
									<tr>
										...
										<td>
											...
											$idUsuario = $this->FunctionsGeneral->getFieldFromTableNotId("COT_SOLICITUD", "ID_USUARIO", "ID", $value->SOLICITUD);
											$telefono = $this->encryption->decrypt($this->FunctionsGeneral->getFieldFromTableNotId("COT_USUARIO", "TELEFONO", "ID", $idUsuario));
											//echo $telefono;
											?>
										...
										<td>
											...
											$idUsuario = $this->FunctionsGeneral->getFieldFromTableNotId("COT_COTIZACION", "VENDEDOR", "ID", $value->ID);
										 	$telefono = $this->FunctionsGeneral->getFieldFromTableNotId("ADM_USUARIO", "TELEFONO", "ID", $idUsuario );
											//echo $telefono;
											?>
											<a href="https://api.whatsapp.com/send/?phone=57<?PHP echo $telefono ?>&text=Hola&type=phone_number&app_absent=0" target="_blank">
												<img src="<?= base_url() ?>assets/images/logo-wasap.png" width="50" height="50">
