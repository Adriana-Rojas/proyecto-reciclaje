...
<!-- Start Page Content -->
<!-- ============================================================== -->
<form class=" form-horizontal" role="form" action="<?= base_url() ?>SystemUserDefine/saveRegister" id="form_sample_3" method="post" autocomplete="off">
	<div class="row">
		<div class="col-12">
			<div class="card">
				<div class="card-body">
				...
				<div class="form-group">
					...
					<div class="col-md-12">
						<input type="text" class="form-control" id="codigo" name="codigo" value="<?= $id ?>" <?= $readOnly; ?> placeholder="Ej. pepe.perdomo">
				...
				<div class="form-group">
					...
					<div class="col-md-12">
						<input type="text" class="form-control" id="nombre" name="nombre" value="<?= $nombre ?>" placeholder="Ej. Pepe ">
						<div class="form-control-feedback"> </div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-12">
						<input type="text" class="form-control" id="apellido" name="apellido" value="<?= $apellido ?>" placeholder="Ej. Perdomo">
						<div class="form-control-feedback"> </div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-12">
						<input type="text" class="form-control" id="correo" name="correo" value="<?= $correo ?>" placeholder="Ej. correo@correo.com.co">
						<div class="form-control-feedback"> </div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-12">
						<input type="text" class="form-control" id="telefono" name="telefono" value="<?= $telefono ?>" placeholder="Ej. 3219779439">
						<div class="form-control-feedback"> </div>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-12" for="ruta">Ruta*</label>
					<div class="col-md-12">
						<input type="text" class="form-control" id="ruta" name="ruta" value="<?php $texto = $ruta;
				...
				<div class="form-group">
					...
					<div class="col-md-12">
						<input type="text" class="form-control" id="pagina" name="pagina" value="<?= $pagina ?>" placeholder="Ej. MainApp/board">
						<div class="form-control-feedback"> </div>
					</div>
				</div>
			</div>
