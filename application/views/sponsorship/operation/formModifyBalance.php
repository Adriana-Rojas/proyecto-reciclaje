...
?>
                ...
                action="<?= base_url()?>SponsorshipsAppFundManagement/saveBalance" 
                id="form_sample_3" 
                method="post"       
                autocomplete="off">
	                <div class="row">
	                    <div class="col-12">
	                        <div class="card">
	                            ...
	                            <!-- 
	                            <div class="form-group">
                               		<label class="col-md-12" for="fondo">Fondos *</label>
                                    <div class="col-md-12">
                              ...
                              <div class="form-group " >
	                           ...
	                           <div class="form-group">
                               		<label class="col-md-12" for="accion">Acci&oacute;n *</label>
                                    <div class="col-md-12">
	                                    <select class="form-control" id="accion" name="accion">
                                        	<option value="">--- Seleccione una opci&oacute;n ---</option>
                                            <option value="1">Adicionar valor al saldo del fondo</option>
                                            <option value="2">Retirar valor al saldo del fondo</option>
                                        </select>
	                                    <div class="form-control-feedback" > </div>
                                    </div>
                               </div>
