...
<body>
	...
	<!-- ============================================================== -->
	<section id="wrapper" class="login-register login-sidebar" style="background-image:url(<?= base_url() ?>assets/images/background/imgfondo.jpg);background-size: 75%;background-position: 0% 0%;">
		...
		<div class="login-box card">
			...
			<div class="card-body">
				...
				<div class="col-xs-12 text-dark pull-right">
				<small>  <a href="http://www.freepik.com">Designed by pikisuperstar-Designed by rawpixel.com/ Freepik</a></small>
				</div>
